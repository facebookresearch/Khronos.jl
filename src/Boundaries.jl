...
"""
get_pml_conductivity_from_field(sim::SimulationData, ::Magnetic, ::X) =
    sim.boundary_data.σBx
get_pml_conductivity_from_field(sim::SimulationData, ::Magnetic, ::Y) =
    sim.boundary_data.σBy
get_pml_conductivity_from_field(sim::SimulationData, ::Magnetic, ::Z) =
    sim.boundary_data.σBz
get_pml_conductivity_from_field(sim::SimulationData, ::Electric, ::X) =
    sim.boundary_data.σDx
get_pml_conductivity_from_field(sim::SimulationData, ::Electric, ::Y) =
    sim.boundary_data.σDy
get_pml_conductivity_from_field(sim::SimulationData, ::Electric, ::Z) =
