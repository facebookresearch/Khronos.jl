...
@with_kw struct Volume
    center::Vector{Real} = [0., 0., 0.]
    size::Vector{Real} = [0., 0., 0.]
end
...
# Convenience wrapper
Simulation(;kwargs...) = SimulationData{backend_number, backend_array, complex_backend_number, complex_backend_array}(;kwargs...)